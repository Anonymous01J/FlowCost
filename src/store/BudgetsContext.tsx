...
const MOCK_BUDGETS: Budget[] = [
  {
    id: '1',
    name: 'Producción de Queso Artesanal',
    date: '2026-03-01',
    totalUSD: 1240.5,
    totalBS: 45278.25,
    status: 'listo',
    data: {
      name: 'Producción de Queso Artesanal',
      exchangeRate: 36.5, profitMarginPct: 30, lotQuantity: 50,
      vatPct: 16, saleUnit: 'kg', customSaleUnit: '',
      rawMaterials: [], laborItems: [], indirectCosts: [],
    },
  },
  {
    id: '2',
    name: 'Servicio de Diseño Gráfico Q1',
    date: '2026-03-05',
    totalUSD: 3800.0,
    totalBS: 138700.0,
    status: 'listo',
    data: {
      name: 'Servicio de Diseño Gráfico Q1',
      exchangeRate: 36.5, profitMarginPct: 45, lotQuantity: 1,
  ...
  {
    id: '3',
    name: 'Fabricación Muebles Oficina – Lote A',
    date: '2026-03-08',
    totalUSD: 6512.75,
    totalBS: 237716.38,
    ...
    data: {
      name: 'Fabricación Muebles Oficina – Lote A',
      exchangeRate: 36.5, profitMarginPct: 25, lotQuantity: 10,
      vatPct: 16, saleUnit: 'unidad', customSaleUnit: '',
      rawMaterials: [], laborItems: [], indirectCosts: [],
    },
  },
